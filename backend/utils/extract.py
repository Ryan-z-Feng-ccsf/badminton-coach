...
def extract_body_part(frame: int, pose_data: dict, joint_name: str, key: str = 'joints') -> np.ndarray:
    """
    ...
    """
    coords = pose_data[frame][key][joint_name]
    return np.array(coords)


def extract_body_parts(pose_data: dict, joint_name: str, key: str = 'joints') -> np.ndarray:
    """
    ...
    """
    return np.array([pose_data[frame][key][joint_name] for frame in sorted(pose_data.keys())])


def extract_coords(pose_data: dict, joint_name: str, coords_idx: int = 0, key: str = 'joints') -> list:
    """
